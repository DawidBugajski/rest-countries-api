...
const Header = () => {
  ...
  return (
    <div className='flex items-center justify-between h-24 pl-4 border-b-2 shadow-lg border-LM_VeryLightGray sm:px-8 sm:text-lg lg:text-2xl 2xl:px-11 dark:bg-DM_DarkBlue dark:text-white dark:border-DM_DarkBlue '>
